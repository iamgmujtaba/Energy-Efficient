...
//This is start application second activity
        ...
        for(UidInfo uidInfo : uidInfos) {
          ...
          switch(keyId) {
            case KEY_CURRENT_POWER:
             ...
             // Log.e("KEY_CURRENT_POWER", "KEY_CURRENT_POWER");
              break;
            case KEY_AVERAGE_POWER:
             ...
             // Log.e("KEY_AVERAGE_POWER", "KEY_AVERAGE_POWER");
              break;
            case KEY_TOTAL_ENERGY:
              uidInfo.key = uidInfo.totalEnergy;
              uidInfo.unit = "J";
              
              //Log.e("KEY_TOTAL_ENERGY", "Energy & time Start Total");
              break;
            default:
              uidInfo.key = uidInfo.currentPower;
              uidInfo.unit = "W";
...
public void run() {
  ...
  private static class UidPowerView extends LinearLayout {
    ...
    public void init(UidInfo uidInfo, int keyType) {
      ...
      long secs = Math.round(uidInfo.runtime);
      ...
      //Application log total power consumption
      
      Log.e("info -----",String.format("%1$.1f%% [%3$d:%4$02d:%5$02d] %2$s\n" +"%6$.1f %7$s%8$s",
              uidInfo.percentage, name, secs / 60 / 60, (secs / 60) % 60,
              secs % 60, uidInfo.key, prefix, uidInfo.unit));
    }
  }
